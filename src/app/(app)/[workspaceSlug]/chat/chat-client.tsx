...
export function ChatClient({ workspaceId }: ChatClientProps) {
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground gap-3">
            ...
            <p className="text-sm max-w-xs">
              Ask anything about your documents. The AI will search through them
              to find the answer.
            </p>
          </div>
        ) : (
                      ...
                      isUser ? (
                        ...
                        <ReactMarkdown
                          ...
                          components={{
                            ...
                            blockquote: ({ children }) => (
                              <blockquote className="border-l-2 border-current/30 pl-3 italic opacity-80 my-2">{children}</blockquote>
                            ),
                          }}
                        >
                          {part.text}
